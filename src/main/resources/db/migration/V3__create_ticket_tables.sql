...
CREATE TABLE tickets (
    ...
    first_response_due_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    resolution_due_at TIMESTAMP(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6),
    first_responded_at TIMESTAMP(6) NULL DEFAULT NULL,
    ...
    sla_paused_at TIMESTAMP(6) NULL DEFAULT NULL,
